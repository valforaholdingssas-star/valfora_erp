...
def _llm_interpret(
    *,
    ...
    system = (
        ...
        "(ej: 'quiero más información', 'Buenas tardes crear página web', "
        "'básica para vender un producto', 'si con carrito', preguntas de precio).\n"
        "NUNCA uses start_booking solo porque el cliente describe un producto o saluda. "
        "start_booking SOLO si pide explícitamente reunirse/agendar/cita/llamada "
        "o afirma (dale/ok/sí) tras una invitación reciente a reunirse.\n"
